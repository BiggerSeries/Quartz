...
public class GLMainProgram {
    ...
    public void reload() {
        ...
        try {
            ...
            String vertPrepend =
                    "#define POSITION_LOCATION " + MagicNumbers.GL.POSITION_LOCATION + "\n" +
                            "#define COLOR_LOCATION " + MagicNumbers.GL.COLOR_LOCATION + "\n" +
                            "#define TEX_COORD_LOCATION " + MagicNumbers.GL.TEX_COORD_LOCATION + "\n" +
                            "#define LIGHTINFO_LOCATION " + MagicNumbers.GL.LIGHTINFO_LOCATION + "\n" +
                            "#define WORLD_POSITION_LOCATION " + MagicNumbers.GL.WORLD_POSITION_LOCATION + "\n" +
                            "#define DYNAMIC_MATRIX_ID_LOCATION " + MagicNumbers.GL.DYNAMIC_MATRIX_ID_LOCATION + "\n" +
    ...
    private void onReloaded() {
        ...
        glProgramUniform1i(info.cutoutFragmentShader, CUTOUT_ATLAS_TEXTURE_UNIFORM_LOCATION, MagicNumbers.GL.ATLAS_TEXTURE_UNIT);
        glProgramUniform1i(info.cutoutFragmentShader, CUTOUT_LIGHTMAP_TEXTURE_UNIFORM_LOCATION, MagicNumbers.GL.LIGHTMAP_TEXTURE_UNIT);
    }
