...
//import net.roguelogix.quartz.internal.gl.GLStateTracker;
...
//    private static final int CHUNK_UPDATES_PER_FRAME = 4;
...
//
//        computeProgram = glCreateShaderProgramv(GL_COMPUTE_SHADER, Util.readResourceLocation(new ResourceLocation(Quartz.modid, "shaders/gl46/light_chunks.comp")));
//        if (glGetProgrami(computeProgram, GL_LINK_STATUS) != GL_TRUE) {
//            final var infoLog = glGetProgramInfoLog(computeProgram);
//            glDeleteShader(computeProgram);
//            glDeleteProgram(computeProgram);
//            throw new IllegalStateException("Compute program link failed for " + computeProgram + '\n' + infoLog + '\n');
//        }
//    }
//
...
//            final int texelIndex = tempVec.x + (24 * (tempVec.y + (64 * tempVec.z)));
//            lookupData.putShortIdx(texelIndex, lookupIndex);
//        }
//        nglTextureSubImage3D(lookupTexture, 0, 0, 0, 0, 64, 24, 64, GL_RED, GL_UNSIGNED_SHORT, lookupData.pointer());
//    }
//
...
//            int lightChunkX = (lightChunkIndex >> 10) & 0x1F;
//            int lightChunkY = (lightChunkIndex >> 10) & 0x1;
//            int lightChunkZ = lightChunkIndex & 0x3FF;
//            glProgramUniform3ui(computeProgram, 0, lightChunkX * 17, lightChunkY * 320, lightChunkZ);
//            glProgramUniform1ui(computeProgram, 1, 0);
//            GLStateTracker.bindProgram(computeProgram);
