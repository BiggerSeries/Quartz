...
public class Gl46InstanceManager {
    ...
    @Nullable
    GL46Instance createInstance(Vector3ic position, @Nullable DynamicMatrix dynamicMatrix, @Nullable Matrix4fc staticMatrix, @Nullable AABBi aabb) {
    ...
    GL46Instance createInstance(Vector3ic position, @Nullable DynamicMatrixManager.Matrix dynamicMatrix, @Nullable Matrix4fc staticMatrix, @Nullable AABBi aabb) {
