...
public record PointerWrapper(long pointer, long size) {
    ...
    public void putVector3i(long offset, Vector3ic vector) {
        ...
        MemUtil.MemUtilUnsafe.put((Vector3i) vector, pointer + offset);
    }
    
    public void putVector3f(long offset, Vector3fc vector) {
        checkRange(offset, 12, 16);
        MemUtil.MemUtilUnsafe.put((Vector3f) vector, pointer + offset);
    }
    
    public void putVector4i(long offset, Vector4ic vector) {
        checkRange(offset, 16);
        MemUtil.MemUtilUnsafe.put((Vector4i) vector, pointer + offset);
    }
    
    public void putVector4f(long offset, Vector4fc vector) {
        checkRange(offset, 16);
        MemUtil.MemUtilUnsafe.put((Vector4f) vector, pointer + offset);
    }
    
    public void putMatrix4f(long offset, Matrix4fc matrix4fc) {
        checkRange(offset, 64, 16);
        MemUtil.MemUtilUnsafe.put((Matrix4f) matrix4fc, pointer + offset);
    }
    
    public void putMatrix3x4f(long offset, Matrix4fc matrix4fc) {
        checkRange(offset, 48, 16);
        MemUtil.MemUtilUnsafe.put3x4((Matrix4f) matrix4fc, pointer + offset);
    }
    ...
    public void getMatrix4f(long offset, Matrix4f matrix4fc) {
        checkRange(offset, 64, 16);
